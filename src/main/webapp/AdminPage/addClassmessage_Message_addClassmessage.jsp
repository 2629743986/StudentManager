...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="js/checkClassmessageNameAjax.js" type="text/javascript"></script>	
	<script src="../js/checkClassmessageNameAjax.js" type="text/javascript"></script>	
...
<h2 class="mbx">添加班级信息 &gt; 添加班级信息</h2>
<div class="morebt">
    

<ul id="ulStudMsgHeadTab">
    <li><a class="tab2">添加班级信息</a> </li>
</ul>

</div>
<div class="cztable">
	<form action="addClassmessageAdmin" method="post" onSubmit="return checkName()">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">

        <tr>
            <td width="91" align="right">班级名字：</td>
            <td colspan="5"><input type="text" value="" name="classmessageName" id="classmessageName" onChange="return checkName()"/></td>
        </tr>
        <tr>
            ...
            <td colspan="5">
            	...
            	<c:forEach var="grade_list" items="${requestScope.grade_list}" >
				  <option value="${grade_list.gradeId }">${grade_list.gradeName }</option>
				</c:forEach>
				</select>
            </td>
        </tr>
        <tr>
        	<td width="91" align="right">所属届级：</td>
        	<td colspan="5"><input type="text" value="" name="classmessageGradeName" id="classmessageGradeName" placeholder="例如15,14"/></td>
        </tr>
        <tr>
            <td width="91" align="right">所属专业：</td>
            <td colspan="5">
            	<select name="professionId" id="professionId">
            	<c:forEach var="profession_list" items="${requestScope.profession_list}" >
				  <option value="${profession_list.professionId }">${profession_list.professionName }</option>
				</c:forEach>
				</select>
            </td>
        </tr>
