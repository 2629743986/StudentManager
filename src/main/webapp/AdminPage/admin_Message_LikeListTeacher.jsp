	...
	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "TeacherPage";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
   ...
   <a href="StudentPageAdmin" style="font-size: 18px">返回</a>
    <div class="morebt">
        <ul>
            <li><a class="tab2" href="#">辅导员助理查询结果信息列表</a></li>  
        </ul>
    </div>
    <div class="cztable">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <c:forEach var="teacher_list" items="${requestScope.teacher_list}" >
			        <tr>
			            <th scope="col">${teacher_list.teacherId }</th>
			            <th scope="col">${teacher_list.teacherName }</th>
			            <th scope="col">${teacher_list.teacherPhone }</th>  
			            <th scope="col"> 
			            	<a href="findTeacherByIds?teacherId=${teacher_list.teacherId }" style="color: red">详情</a>/
			            	<a href="updateTeacherAdminIndex?teacherId=${teacher_list.teacherId }" style="color: red">修改</a>/
	                    	<a href="deleteTeacherById?teacherId=${teacher_list.teacherId }" style="color: red" onClick="return confirm('确定将此记录删除?')">删除</a>
                   		</th>       
			        </tr>
      			</c:forEach>
            </tbody>
