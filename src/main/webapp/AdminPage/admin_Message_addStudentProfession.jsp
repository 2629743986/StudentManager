            ...
            <div id="logo">
                ...
                <div class="blog_nav">
                    <ul>
                        ...
                        <li><a href="EducationCenter/Score.aspx.html">所有专业</a></li>
...
<div class="cztable">
	<form action="addClassMessage?studentId=${student.studentId} " method="post">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td align="right">分配学院：</td>
            <td colspan="5">
            	<select name="classmessageId" id="classmessageId">
            	<c:forEach var="list" items="${requestScope.list}" >
				  <option value="${list.college.collegeId }">${list.college.collegeName }</option>
				</c:forEach>
				</select>
            </td>
        </tr>
