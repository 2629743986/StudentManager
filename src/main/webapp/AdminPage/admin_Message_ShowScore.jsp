 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "StudentAchievementPage?studentId=${student_admin_message.studentId }";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
				...
				<div class="cdlist">
                    ...
                    <div class="cdlist">
                        ...
                        <div>
                         ...
                         <div>
                            <a href="TeacherPageAdmin">助理辅导员信息  </a>
                        </div>
                    </div> 
                    <div class="ta1">
                        <strong>添加信息</strong>
                    ...
                    <div class="cdlist">
                    	 ...
                    	 <div>
                           <a href="addTeacherList">添加助理辅导员信息 </a>
                        </div>
    ...
    <div class="morebt">
        <ul>
           	<li><a class="tab2" href="findStudentById?studentId=${studentId }">学生个人资料</a> </li>
		    <li><a class="tab2" href="AdminPage/admin_Message_addAchievement.jsp">添加成绩</a> </li>
    ...
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Achievement">
			        <tr>
			            ...
			            <th scope="col"> 
	                    	<a href="deleteScoreByid?achievementId=<s:property value="#Achievement.achievementId"/>&studentId=<s:property value="#Achievement.student.studentId"/>" style="color: red" onclick="return confirm('确定将此记录删除?')">删除</a>
                   		</th>       
			        </tr>
      			</s:iterator>
            </tbody>
        ...
        <s:else>
            <a href="StudentAchievementPage?studentId=${student_admin_message.studentId }">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentAchievementPage?page=<s:property value="#request.pageBean.currentPage - 1"/>&studentId=${student_admin_message.studentId }">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="StudentAchievementPage?page=<s:property value="#request.pageBean.currentPage + 1"/>&studentId=${student_admin_message.studentId }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentAchievementPage?page=<s:property value="#request.pageBean.totalPage"/>&studentId=${student_admin_message.studentId }">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="StudentAchievementPage?studentId=${student_admin_message.studentId }" onSubmit="return validate();">
