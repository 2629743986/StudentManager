...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="js/checkProfessionNameAjax.js" type="text/javascript"></script>	
	<script src="../js/checkProfessionNameAjax.js" type="text/javascript"></script>
...
<h2 class="mbx">添加专业信息 &gt; 添加专业信息</h2>
<div class="morebt">
    

<ul id="ulStudMsgHeadTab">
    <li><a class="tab2">添加专业信息</a> </li>
</ul>

</div>
<div class="cztable">
	<form action="addProfession" method="post" onSubmit="return checkName()">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">

        <tr>
            <td width="91" align="right">专业名称：</td>
            <td colspan="5"><input type="text" value="" name="professionName" id="professionName" onChange="return checkName()"/></td>
        </tr>
        <tr>
            ...
            <select name="collegeId" id="collegeId">
            	<c:forEach var="college_list" items="${requestScope.college_list}" >
				  <option value="${college_list.collegeId }">${college_list.collegeName }</option>
				</c:forEach>
			</select>
            </td>
        </tr>
