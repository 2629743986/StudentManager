	...
	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "AdminAdminmessagePage";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
            <li><a class="tab2">未处理学生信息</a></li>  
            <li><a href="AdminAdminmessagePages" class="tab2">已处理学生信息</a></li> 
        </ul>
    </div>
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Teachermessage">
			        <tr>
			            ...
			            <th scope="col"> 
			            	<a href="ReplyMessage?teacherMessageId=<s:property value="#Teachermessage.teacherMessageId"/>" style="color: red" >详情</a>
        ...
        <s:else>
            <a href="AdminAdminmessagePage">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="AdminAdminmessagePage?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="AdminAdminmessagePage?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="AdminAdminmessagePage?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="AdminAdminmessagePage" onSubmit="return validate();">
