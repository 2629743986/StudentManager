...
<ul id="ulStudMsgHeadTab">
    <li><a class="tab2">添加班级辅导员班级信息</a> </li>
</ul>

</div>
<div class="cztable">
	<form action="addClassmessageTeacherAdmin " method="post">
	<input type="hidden" name="teacherId" value="${teacher_message.teacherId}"/>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">

        <tr>
            <td width="91" align="right">教师姓名：</td>
            <td colspan="5">${teacher_message.teacherName}&nbsp;</td>
        </tr>
        <tr>
           <td align="right">管理班级：</td>
            <td colspan="3">
            	<c:forEach var="listClassmessage" items="${requestScope.listClassmessage}" >
				 	<input name="classmessageId" type="checkbox" value="${listClassmessage.classmessageId }">${listClassmessage.classmessageName }<br/>
				</c:forEach>
            </td>
        </tr>
         <tr>
