	...
	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "StudentPageAdmin";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <h2 class="mbx">
       学生信息 &gt; 学生信息</h2>
       <form action="LikeStudentPageAdmin" method="post" onSubmit="return checkSelect()">
        ...
        <form action="StudentPageGrade" method="post">
       	<div style="text-align: center;">
       		按年级查询
       		<input name="studentGradeName" id="studentGradeName" type="text"/>
       		<%-- <select name="gradeId" id="gradeId">
				  <option value="4">大一</option>
				  <option value="5">大二</option>
        ...
        <form action="Find_Citationlevel" method="post">
       	<div style="text-align: center;">
       		查询获奖等级的学生
    ...
    <div class="cztable">
        ...
        <s:else>
            <a href="StudentPageAdmin">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentPageAdmin?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="StudentPageAdmin?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentPageAdmin?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="StudentPageAdmin" onSubmit="return validate();">
