...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="../js/addTeacherVerification.js" type="text/javascript"></script>
	<script src="js/addTeacherVerification.js" type="text/javascript"></script>
    ...
    <div class="page">
        <div class="box mtop">
           <div class="leftbox">
            ...
            <div class="rightbox">
<h2 class="mbx">辅导员助理信息 &gt;添加辅导员助理信息</h2> 
<div class="morebt">
    

<ul id="ulStudMsgHeadTab">
    <li><a class="tab2">添加辅导员助理资料</a></li>
</ul>

</div>
<div class="cztable">
	<form action="addTeacherAdmin" method="post" enctype="multipart/form-data" onSubmit="return checkName()">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input type="text" id="userName" name="userName" maxlength="10" onChange="return checkName()" placeholder="必须为数字"/></td>
            ...
            辅导员助理照片<label style="color: red;">(必须选择图片)</label>
	             <div align="center">
	            	<ul id="warp">
					  <li>
        ...
        <tr>
            <td align="right" width="80">名字：</td>
            <td><input type="text" id="teacherName" name="teacherName" maxlength="10"/></td>
            <td align="right" width="80">工号：</td>
            <td><input type="text" id="workNumber" name="workNumber" maxlength="10" placeholder="与登录帐号必须一致"/></td>
        </tr>
        ...
        <tr>
         ...
         <tr>
            ...
            <td><input type="text" id="teacherAddress" name="teacherAddress" maxlength="20"/></td>
            <td align="right">电话号码：</td>
            <td><input type="text" id="teacherPhone" name="teacherPhone" maxlength="20"/></td>
        </tr>
         <tr>
         	<td  align="right">QQ号码：</td>
            <td colspan="3"><input type="text" id="teacherQq" name="teacherQq" maxlength="20"/></td>
         </tr>
          <tr>
