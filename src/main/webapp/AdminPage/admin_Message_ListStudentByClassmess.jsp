	...
	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "StudentPageClassmessId?classmessageId=${classmessageId}";
	            return false;
	        }
	        if (page <= <s:property value="#request.pageBean.totalPage"/>) {
	        	window.document.location.href = "StudentPageClassmessId?classmessageId=${classmessageId}&page="+pages;
	            return false;
			}
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="cztable">
        ...
        <s:else>
            <a href="StudentPageClassmessId?classmessageId=${classmessageId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentPageClassmessId?page=<s:property value="#request.pageBean.currentPage - 1"/>&classmessageId=${classmessageId}">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="StudentPageClassmessId?page=<s:property value="#request.pageBean.currentPage + 1"/>&classmessageId=${classmessageId}">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentPageClassmessId?page=<s:property value="#request.pageBean.totalPage"/>&classmessageId=${classmessageId}">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="StudentPageClassmessId?classmessageId=${classmessageId}" onSubmit="return validate();">
