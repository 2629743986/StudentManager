...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
            <li><a class="tab2" href="#">学生查询结果信息列表</a></li>  
        </ul>
    </div>
    <div class="cztable">
                ...
                <tr style="height: 25px" align="center">
             	 ...
             	 <c:forEach var="student_list" items="${requestScope.student_list}" >
			        <tr>
			            ...
			            <th scope="col">${student_list.studentGradeName }级</th> 
			            <th scope="col">${student_list.state }</th> 
			            <th scope="col"> 
			            	<a href="findStudentById?studentId=${student_list.studentId }" style="color: red">详情</a>/
			            	<a href="UpdateSutdentAdminIndex?studentId=${student_list.studentId }" style="color: red">修改</a>/
	                    	<a href="deleteStudentAdmin?studentId=${student_list.studentId }&userId=${student_list.users.userId }" style="color: red" onClick="return confirm('确定将此记录删除?')">删除</a>
                   		</th>       
			        </tr>
			        </c:forEach>
            </tbody>
