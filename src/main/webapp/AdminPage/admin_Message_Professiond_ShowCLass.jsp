...
<div class="cztable">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr>
            <td align="left" colspan="6" style="color: red;">专业所属班级信息：</td>
        </tr>
         
        <tr>
            <td width="91" align="right">班级名称：</td>
            <td colspan="5">
            	<c:forEach var="list_message" items="${requestScope.list_message}" >
            		<a href="ShowClassmessageAdmin?classmessageId=${list_message.classmessageId }">${list_message.classmessageName }</a>&nbsp;<br/>
            	</c:forEach>
            </td>
        </tr>
