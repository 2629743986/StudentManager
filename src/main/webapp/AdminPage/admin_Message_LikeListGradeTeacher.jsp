...
<div class="banner">
    ...
    <h2 class="mbx">
      辅导员信息 &gt;   辅导员信息</h2>
       <a href="GradeteacherPageAdmin" style="font-size: 18px">返回</a>
    <div class="morebt">
        <ul>
            <li><a class="tab2" href="#">辅导员查询结果信息列表</a></li>     
        </ul>
    </div>
    <div class="cztable">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <c:forEach var="GradeTeacher_list" items="${requestScope.GradeTeacher_list}" >
			        <tr>
			            <th scope="col">${GradeTeacher_list.gradeteacherId }</th>
			            <th scope="col">${GradeTeacher_list.gradeteacherName }</th>
			            <th scope="col">${GradeTeacher_list.grade.gradeName }</th>
			            <th scope="col">${GradeTeacher_list.gradeteacherPhone }</th>  
			            <th scope="col"> 
			            	<a href="finGradeteacherById?gradeteacherId=${GradeTeacher_list.gradeteacherId }" style="color: red">详情</a>/
			            	<a href="updateGradeTeacherIndex?gradeteacherId=${GradeTeacher_list.gradeteacherId }" style="color: red">修改</a>/
	                    	<a href="deleteGradeById?gradeteacherId=" style="color: red" onClick="return confirm('确定将此记录删除?')">删除</a>
                   		</th>       
			        </tr>
      			</c:forEach>
            </tbody>
