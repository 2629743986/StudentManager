	...
	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "GradeTeacherTeacherPage?gradeId=${ gradeteacher_message.grade.gradeId}";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
            <li><a class="tab2" href="#">班级辅导员信息列表</a></li> 
    ...
    <div class="cztable">
            ...
            <tbody>
                ...
                <s:iterator value="#request.pageBean.list" id="Teacher">
			        <tr>
			            ...
			            <th scope="col"> 
			            	<a href="findTeacherGradeTeacherById?teacherId=<s:property value="#Teacher.teacherId"/>" style="color: red">详情</a>
        ...
        <s:else>
            <a href="GradeTeacherTeacherPage?gradeId=${ gradeteacher_message.grade.gradeId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="GradeTeacherTeacherPage?page=<s:property value="#request.pageBean.currentPage - 1"/>&gradeId=${ gradeteacher_message.grade.gradeId}">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="GradeTeacherTeacherPage?page=<s:property value="#request.pageBean.currentPage + 1"/>&gradeId=${ gradeteacher_message.grade.gradeId}">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="GradeTeacherTeacherPage?page=<s:property value="#request.pageBean.totalPage"/>&gradeId=${ gradeteacher_message.grade.gradeId}">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="GradeTeacherTeacherPage?gradeId=${ gradeteacher_message.grade.gradeId}" onsubmit="return validate();">
