 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "ShowListCitationGradeTeacher?studentId=${student_admin_message.studentId }";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="cztable">
              ...
              <s:iterator value="#request.pageBean.list" id="Citation">
			        <tr>
			            ...
			            <%-- 	 <s:if test="#Citation.state==0">
				           	...
				           	<%-- <s:if test="#Citation.state==1"> --%>
				           		<a href="SwhoCitationGradeTeacher?citationId=<s:property value="#Citation.citationId"/>" style="color: red" >详情</a>
				           	<%-- </s:if> --%>
                   		</th>       
			        </tr>
      			</s:iterator>
        ...
        <s:else>
            <a href="ShowListCitationGradeTeacher?studentId=${student_admin_message.studentId }">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="ShowListCitationGradeTeacher?page=<s:property value="#request.pageBean.currentPage - 1"/>&studentId=${student_admin_message.studentId }">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="ShowListCitationGradeTeacher?page=<s:property value="#request.pageBean.currentPage + 1"/>&studentId=${student_admin_message.studentId }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="ShowListCitationGradeTeacher?page=<s:property value="#request.pageBean.totalPage"/>&studentId=${student_admin_message.studentId }">尾页</a>
        </s:if>
