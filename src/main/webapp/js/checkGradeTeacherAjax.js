...
function httpRequest(reqType,url,async,resFun,parameter){	
	...
	function checkGradeTeacherName(){
		var gradeId=document.getElementById("gradeId").value;
		var collegeId=document.getElementById("collegeId").value;
			//请求参数
		    request=httpRequest("post","servlet/CheckGradeTeacher.servlet?gradeId="+gradeId+"&collegeId="+collegeId,true,callbackFunc);//调用Ajax提交请求方法  
