...
<div class="cztable">  
    ...
    <span id="table">
     <table width="100%" cellpadding="0" cellspacing="0">
	    <tr>
	      <td colspan="5">
	      	<label style="color:#F00">登录信息</label>
	      </td>
	    </tr>
	    <tr>
	  ...
	  <tr>
	    ...
	    <td colspan="1">${student_message.studentNumber }&nbsp;</td>
	  </tr>
	   <tr>
	     <td align="right">性别：</td>
            <td>${student_message.sex }&nbsp;</td>
            <td align="right">民族：</td>
            <td colspan="1">${student_message.nation }&nbsp;</td>
	    </tr>
	   <tr>
	    <td align="right">出生年月日：</td>
            <td>${student_message.birthday }&nbsp;</td>
            <td align="right">出生地：</td>
            <td colspan="1">${student_message.placeofBirth }&nbsp;</td>
	    </tr>
	   <tr>
	     <td align="right">身高：</td>
            <td>${student_message.height }&nbsp;</td>
            <td align="right">体重：</td>
            <td colspan="2">${student_message.weight }&nbsp;</td>
	  </tr>
	   <tr>
	     <td align="right">兴趣爱好：</td>
            <td colspan="4">${student_message.interest }&nbsp;
	   ...
	   <tr>
	       <td align="right">政治面貌：</td>
            ...
            <td colspan="4">${student_message.political.politicallandscape }&nbsp; 
				 ...
				 <c:choose>  
				   <c:when test="${student_message.politicallandscapestate==4}">  
				   <p style="color: red;">(没审批)</p>  
				   </c:when>  
				     
				   <c:when test="${student_message.politicallandscapestate==1}">  
				   <p style="color: red;">(审批通过)</p>  
				   </c:when>  
				    <c:when test="${student_message.politicallandscapestate==2}">  
				   <p style="color: red;">(辅导员审批通过)</p>  
				   </c:when> 
				    <c:when test="${student_message.politicallandscapestate==3}">  
				   <p style="color: red;">(辅导员助理审批通过)</p>  
				   </c:when> 
				</c:choose>  
            </td>
	  </tr>
	   <tr>
	      <td align="right">身份证号码：</td>
            <td colspan="4">${student_message.idcard }&nbsp;
            	
            </td>
	  </tr>
	   <tr>
	     <td align="left" colspan="5" style="color: red;">学生在校信息：</td>
	  </tr>
	   <tr>
	      <td align="right">在读学校：</td>
            <td colspan="4">${student_message.shcoolName }&nbsp;</td>
	  </tr>
	   <tr>
	    <td align="right">在读专业：</td>
            <td>${student_message.classmessage.profession.professionName }&nbsp;</td>
            <td align="right">所属学院：</td>
            <td colspan="2">${student_message.college.collegeName }&nbsp;</td>
	  </tr>
	   <tr>
         	<td align="right">所在年级：</td>
            <td>${student_message.studentGradeName }级&nbsp;</td>
            <td align="right">所在班级：</td>
            <td colspan="2">${student_message.classmessage.classmessageName }&nbsp;</td>
          </tr>
            
          <tr>
        	
            <td align="right">班级职务：</td>
            <td>${student_message.post.postName }&nbsp;</td>
              <td align="right">所在社团：</td>
            <td colspan="2">${student_message.corporation}&nbsp;</td>
            
           
        </tr>
        <tr>
        	<td align="right">社团职务：</td>
            <td>${student_message.corporationpost}&nbsp;</td>
            <td align="right">入学时间：</td>
            <td colspan="2">${student_message.dateTime}&nbsp;</td>	
        </tr>
        <tr>
        	<td align="right">状态：</td>
            <td>${student_message.state}&nbsp;</td>
             <td align="right">所在宿舍：</td>
            <td colspan="2">${student_message.dormitory}&nbsp;</td>
        </tr>
        <tr>
            <td colspan="5" align="left" style="color: red;">联系方式:</td>
        </tr>
         <tr>
            <td align="right">手机号码：</td>
            <td>${student_message.phoneNumber }</td>
            <td align="right">家庭电话号码：</td>
            <td colspan="2">${student_message.homePhone }</td>
        </tr>
        <tr>
        	<td align="right">QQ：</td>
            <td>${student_message.qqNumber }</td>
            <td align="right">微信：</td>
            <td colspan="2">${student_message.weChat }</td>
          </tr>
        <tr>
        	<td align="right">邮箱：</td>
            <td>${student_message.email }</td>
            <td align="right">联系地址：</td>
            <td colspan="2">${student_message.address }</td>
        </tr>    
        
         <tr>
            <td  align="left" style="color: red;">学生备注:</td>
            <td colspan="4">${student_message.remarks }</td>
        </tr>  
     </table>
    </span>
    </form>
