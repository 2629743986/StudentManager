...
<h2 class="mbx">系统公告信息 &gt; 系统公告信息</h2>
<div class="morebt">
    

<ul id="ulStudMsgHeadTab">
    <li><a class="tab2" href="#">系统信息</a></li>
</ul>
...
<div class="cztable">
    <table width="100%" cellpadding="0" cellspacing="0">
	        <tr>
	            ...
	            <td style="text-align: center;font-size: 19px">${systeminformationMessageStudent.informationTitle }</td>
	        </tr>
	        <tr>
	            <td width="15%" align="right"><div align="right">发布日期： </div></td>
	            <td style="font-size: 19px">${systeminformationMessageStudent.informationDate }</td>
	        </tr>
	        ...
	        <tr>
	            ...
	            <td>
	            	${systeminformationMessageStudent.informationMessage}
	            </td>
	        </tr>
	    </table>
	</div>
