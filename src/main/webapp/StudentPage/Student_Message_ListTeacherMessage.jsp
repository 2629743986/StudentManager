 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "showPageTeacherMessage?studentId=${ student_message.studentId}";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
           	...
           	<li>
           		<form action="TeacherNoReply" method="post" id="from6" name="from6">
                    <input type="hidden" name="studentId" value="${ student_message.studentId}"/>
    ...
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Teachermessage">
			        <tr>
			            ...
			            <th scope="col">
			            	<s:property value="#Teachermessage.gradeteacher.gradeteacherName"/>
			            </th>
			            <th scope="col">
			            ...
			            <th scope="col"> 
			            	<a href="findTeacherMessage?teacherMessageId=<s:property value="#Teachermessage.TeacherMessageId"/>" style="color: red" >详情</a>
                   		</th>       
			        </tr>
      			</s:iterator>
            </tbody>
        ...
        <s:else>
            <a href="showPageTeacherMessage?studentId=${ student_message.studentId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showPageTeacherMessage?page=<s:property value="#request.pageBean.currentPage - 1"/>&studentId=${student_message.studentId }">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="showPageTeacherMessage?page=<s:property value="#request.pageBean.currentPage + 1"/>&studentId=${student_message.studentId }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showPageTeacherMessage?page=<s:property value="#request.pageBean.totalPage"/>&studentId=${student_message.studentId }">尾页</a>
        </s:if>
