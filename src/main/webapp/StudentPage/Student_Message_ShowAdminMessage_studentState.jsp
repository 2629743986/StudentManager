...
<h2 class="mbx">咨询信息 &gt; 咨询信息</h2>
	...
	<ul id="ulStudMsgHeadTab">
    	<li><a class="tab2" href="#">咨询信息回复</a></li>
	</ul>
	</div>
	<div class="cztable">
	...
	<div class="cztable">
	    <table width="100%" cellpadding="0" cellspacing="0">
	        <tr>
	            <td width="15%" align="right"><div align="right">回复标题： </div></td>
	            <td style="text-align: center;font-size: 19px">${reply_message.replyTitle }</td>
	        </tr>
	        <tr>
	            <td width="15%" align="right"><div align="right">发布日期： </div></td>
	            <td style="font-size: 19px">${reply_message.replyDate }</td>
	        </tr>
