 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "StudentAdminmessagePage?studentId=${ student_message.studentId}";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
           	<li><a class="tab2" href="#">辅导员咨询列表</a> </li>
           	<li>
           	...
           	<li>
           	 ...
           	 <li>
           		<form action="TeacherNoReply" method="post" id="from8" name="from8">
                    <input type="hidden" name="studentId" value="${ student_message.studentId}"/>
                      <a href="javascript:document:from8.submit();" class="tab2">辅导员已处理列表</a>
                </form>
           	 </li>
        </ul>
    </div>
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Adminmessage">
			        <tr>
			            ...
			            <th scope="col"> 
			            	<a href="showStudentAdminMessage?systermMessageId=<s:property value="#Adminmessage.systermMessageId"/>" style="color: red" >详情</a>
                   		</th>       
			        </tr>
      			</s:iterator>
            </tbody>
        ...
        <s:else>
            <a href="StudentAdminmessagePage?studentId=${ student_message.studentId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentAdminmessagePage?page=<s:property value="#request.pageBean.currentPage - 1"/>&studentId=${student_message.studentId }">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="StudentAdminmessagePage?page=<s:property value="#request.pageBean.currentPage + 1"/>&studentId=${student_message.studentId }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentAdminmessagePage?page=<s:property value="#request.pageBean.totalPage"/>&studentId=${student_message.studentId }">尾页</a>
        </s:if>
