    ...
    <div class="page">
        <div class="box mtop">
            <div class="leftbox">
				...
				<div class="cdlist">
					<div>
					<form action="StudentAdminmessagePage" method="post" name="from1" id="from1">
                    ...
                    <div class="cdlist">
                        ...
                        <div>
                            <form action="ShowListCitation" method="post" id="from4" name="from4">
                        		<input type="hidden" name="studentId" value="${ student_message.studentId}"/>
                            	<a href="javascript:document:from4.submit();">我的奖状</a>
                        	</form>
                        </div>
                         <div>
                    ...
                    <div class="cdlist">
                        <div>
                            <form action="StudentMessageAchievementPage" method="post" id="from5" name="from5">
                        		<input type="hidden" name="studentId" value="${ student_message.studentId}"/>
                            	<a href="javascript:document:from5.submit();">我的成绩</a>
                            </form>
                        </div>
                    </div>
		...
		<div class="cztable">  
			<form action="addMessageStudent?studentId=${student_message.studentId }&adminId=${adminId}" method="post" enctype="multipart/form-data"> 
			<table width="100%" cellpadding="0" cellspacing="0">
			        <tr>
			            <td width="15%" align="right"><div align="right">信息标题： </div></td>
			            <td><input id="MessageTitle" size="20" name="MessageTitle" class="input_2"/></td>
			        </tr>
