 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "findStudentScroeTeacher?gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="cztable">
        ...
        <s:else>
            <a href="findStudentScroeTeacher?gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="findStudentScroeTeacher?page=<s:property value="#request.pageBean.currentPage - 1"/>&gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="findStudentScroeTeacher?page=<s:property value="#request.pageBean.currentPage + 1"/>&gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="findStudentScroeTeacher?page=<s:property value="#request.pageBean.totalPage"/>&gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="findStudentScroeTeacher?gradeId=${ teacher_message.grade.gradeId }&classmessageId=${teacher_message.classmessage.classmessageId}" onSubmit="return validate();">
