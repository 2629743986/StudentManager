 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "showPageSysteminformationTeacher";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Systeminformation">
			        <tr>
			            ...
			            <th scope="col">
				           <a href="showSysteminformationByIdTeacher?informationId=<s:property value="#Systeminformation.informationId"/>" style="color: red" >详情</a>
        ...
        <s:else>
            <a href="showPageSysteminformationTeacher">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showPageSysteminformationTeacher?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="showPageSysteminformationTeacher?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showPageSysteminformationTeacher?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="showPageSysteminformationTeacher" onSubmit="return validate();">
