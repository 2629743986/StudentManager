 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "showYesReply?teacherId=${  teacher_message.teacherId}";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="morebt">
        <ul>
           	<li>
           	<form action="showNoReply" method="post" id="from7" name="from7">
                 <input type="hidden" name="teacherId" value="${teacher_message.teacherId }"/>
                 <a href="javascript:document:from7.submit();" class="tab2">咨询列表</a>
            </form>
           	</li>
    ...
    <div class="cztable">
            ...
            <tbody>
              ...
              <s:iterator value="#request.pageBean.list" id="Teacherreply">
			        <tr>
			            ...
			            <th scope="col">
			            	<s:property value="#Teacherreply.teacher.teacherName"/>
			            </th>
			            <th scope="col">
				            已处理
			            </th>  
			            <th scope="col"> 
			            	<a href="FindByIdReply?teacherMessageId=<s:property value="#Teacherreply.teacherReplyId"/>&teacherId=<s:property value="#Teacherreply.teacher.teacherId"/>" style="color: red" >详情</a>/
			            	<a href="deleteTeacherMessageReply?teacherId=${ teacher_message.teacherId}&teacherMessageId=<s:property value="#Teacherreply.teacherReplyId"/>" style="color: red" >删除</a>
                   		</th>       
			        </tr>
      			</s:iterator>
            </tbody>
      ...
      <center>
        ...
        <s:else>
            <a href="showYesReply?teacherId=${  teacher_message.teacherId}">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showYesReply?page=<s:property value="#request.pageBean.currentPage - 1"/>&teacherId=${  teacher_message.teacherId}">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="showYesReply?page=<s:property value="#request.pageBean.currentPage + 1"/>&teacherId=${  teacher_message.teacherId}">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="showYesReply?page=<s:property value="#request.pageBean.totalPage"/>&teacherId=${  teacher_message.teacherId}">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="showYesReply?gradeId=${ teacher_message.grade.gradeId}&teacherId=${  teacher_message.teacherId}" onsubmit="return validate();">
