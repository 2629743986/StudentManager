 	...
 	<script type="text/javascript">
	    function validate(){
	        ...
	        if(page > <s:property value="#request.pageBean.totalPage"/>){
	            ...
	            window.document.location.href = "StudentTeacherAchievementPage?studentId=${student_admin_message.studentId }";
	            return false;
	        }
	        return true;
	    }
...
<div class="banner">
    ...
    <div class="cztable">
        ...
        <s:else>
            <a href="StudentTeacherAchievementPage?studentId=${student_admin_message.studentId }">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentTeacherAchievementPage?page=<s:property value="#request.pageBean.currentPage - 1"/>&studentId=${student_admin_message.studentId }">上一页</a>
        </s:else>
        
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">
            <a href="StudentTeacherAchievementPage?page=<s:property value="#request.pageBean.currentPage + 1"/>&studentId=${student_admin_message.studentId }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="StudentTeacherAchievementPage?page=<s:property value="#request.pageBean.totalPage"/>&studentId=${student_admin_message.studentId }">尾页</a>
        </s:if>
    ...
    <center>
        ...
        <form action="StudentTeacherAchievementPage?studentId=${student_admin_message.studentId }" onSubmit="return validate();">
