...
public class GradeteacherPageBean {
	
	private List<Gradeteacher> list; //通过hql从数据库分页查询出来的list集合,年级辅导员集合
	private int allRows; //总记录数   
	private int totalPage; //总页数
	private int currentPage; //当前页
	
	public List<Gradeteacher> getList() {
		return list;
	}
	public void setList(List<Gradeteacher> list) {
		this.list = list;
	}
