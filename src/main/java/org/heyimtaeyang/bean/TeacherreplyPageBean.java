...
public class TeacherreplyPageBean {
	
	private List<Teacherreply> list; //通过hql从数据库分页查询出来的list集合,成绩集合
	...
	public List<Teacherreply> getList() {
		return list;
	}
	public void setList(List<Teacherreply> list) {
		this.list = list;
	}
